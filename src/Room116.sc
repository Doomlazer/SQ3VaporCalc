	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(11
				...
				(mMouth setCycle: Fwd)
				(proc255_0 116 0 80 {Mark} 91 67 -1 156 70 320)
				(= seconds 8)
			)
			(12
				(proc0_12)
				...
				(proc255_0 116 1 80 {Roger} 91 67 -1 156 70 320)
				(= seconds 8)
			)
			(13
				(proc0_12)
				...
				(rMouth setCel: 0)
				(kMouth setCycle: Fwd)
				(proc255_0 116 2 80 {Ken Williams} 91 67 -1 156 70 320)
				(= seconds 10)
			)
			(14
				(proc0_12)
