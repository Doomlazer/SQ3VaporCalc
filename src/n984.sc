...
(procedure (proc984_0 param1 param2 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 newEventHandler temp11 temp12 newEventHandler_2 temp14 temp15 newEventHandler_3)
	...
	((= temp1 [param2 0])
		add: newEventHandler newEventHandler_2 gRegions gLocales newEventHandler_3
	)
	(-- argc)
	(repeat
		...
		(while (< temp0 argc)
			...
			(and temp3 (IsObject (= temp5 (NodeValue temp3))))
				(if (temp1 firstTrue: #contains temp5)
				else
					...
					(if (== (proc999_1 temp6 90) 0) (-- temp6))
					(if (= temp7 (proc982_1 temp5 param1))
