...
(instance rm040 of Rm
	...
	(method (handleEvent pEvent)
		...
		(if (Said 'look[/area]') (proc255_0 40 0))
	)
)
...
(instance rmScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(if (== global124 0) (= cycles 2) else (= cycles 14))
			)
			(5 (arnsArm setCycle: End self))
			(6
				(if (== global124 0) (= cycles 2) else (= cycles 23))
			)
			(7
			...
			(8
				(if (== global124 0) (= cycles 2) else (= cycles 13))
			)
			(9
				(global2 drawPic: 40 8)
				(arnsHead dispose:)
				(arnsArm dispose:)
			)
