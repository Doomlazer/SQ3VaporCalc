...
(instance rm91 of Rm
	...
	(method (init)
		(super init:)
		(gEgo
			view: (if (gEgo has: 13) 113 else 0)
			setPri: -1
			setCycle: Walk
			setStep: 3 2
			init:
	...
	(method (handleEvent pEvent)
		...
		(switch (pEvent type?)
			(evSAID
				(cond 
					((Said 'look/calendar') (proc255_0 91 0))
					((Said 'look,drink,get/water') (proc255_0 91 1))
					((Said 'look/brush') (proc255_0 91 2))
					((Said 'fart,water/brush') (proc255_0 91 3))
				)
			)
		)
	)
	...
	(method (newRoom newRoomNumber)
		(if
		(and global233 (== newRoomNumber 90) (gEgo has: 12))
			(gEgo posn: (gEgo x?) 187 setDirection: 0)
		else
			(if (== newRoomNumber 90) (gLongSong stop:))
...
(instance rmScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(cond 
					((== gNorth 93) (gEgo posn: 245 1 setMotion: MoveTo 245 30 self))
					((== gNorth 90)
						(proc0_2)
			...
			(1
				(rm91 south: 90)
				(proc0_3)
				(if (and (== gNorth 90) (not global233))
	...
	(method (doit)
		(if (not global233)
			(cond 
				...
				((and seeProblem (== (gEgo view?) 92)) (self setScript: finkScript))
			)
		)
		(super doit:)
	)
